...
public class PruebaLibreria {
    public static void main(String [] args) {
        ...
        libreria.addLibro("Philip K. Dick", "¿Suen~an los androides con ovejas ele´ctricas?", 3.50);
        libreria.addLibro("Isaac Asimov", "Fundacio´n e Imperio", 9.40);
        libreria.addLibro("Ray Bradbury","Fahrenheit 451",7.40);
        libreria.addLibro("Alex Huxley", "Un Mundo Feliz",6.50);
        libreria.addLibro("Isaac Asimov", "La Fundacio´n",7.30);
        libreria.addLibro("William Gibson", "Neuromante", 8.30);
        libreria.addLibro("Isaac Asimov","Segunda Fundacio´n",8.10);
        ...
        System.out.println(libreria.getPrecioFinal("Philip K. Dick", "¿Suen~an los androides con ovejas ele´ctricas?"));
        System.out.println(libreria.getPrecioFinal("isaac asimov", "fundacio´n e imperio"));
        ...
        System.out.println(libreria.getPrecioFinal("Isaac Asimov", "La Fundacio´n"));
        System.out.println(libreria.getPrecioFinal("william gibson", "neuromante"));
        System.out.println(libreria.getPrecioFinal("Isaac Asimov", "Segunda Fundacio´n"));
